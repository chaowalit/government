...
class VdoController extends AdminMsgController{
	...
	public function index(){
		...
		$this->render_view('admin/vdo/main', $data, $this->menu_nav, 1);
	}
	...
	public function form(){
		...
		$this->render_view('admin/vdo/form', $data, $this->menu_nav, 1);
	}
