    ...
    <div class="row sidebar-page">
      ...
      <div class="col-md-3 sidebar right-sidebar custom-page-content">
        ...
        <div class="widget widget-popular-posts">
          <h4>ผลิตภัณฑ์ OTOP <span class="head-line"></span></h4>
          <ul>
            <?php
                if(isset($otop_all[0])){
                    foreach ($otop_all as $key => $value) {
            ?>
            <li>
  ...
  <div class="col-md-9 page-content custom-right-sidebar">
    ...
    <div class="blog-post image-post">
      ...
      <div class="post-content">
        ...
        <h2><a href="#">{{ $otop[0]->title }}</a></h2>
        <ul class="post-meta">
          <li>By <a href="#">Administrator</a></li>
          <li>เมื่อวันที่ {{ date("d-m-Y", strtotime($otop[0]->post_date)) }}</li>
          <!-- <li><a href="#">WordPress</a>, <a href="#">Graphic</a></li>
          <li><a href="#">4 Comments</a></li> -->
        </ul>
        <p><?php echo $otop[0]->detail1 ?></p>
...
<br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                <?php if(isset($otop[0]->file_path)){
                        $path = public_path('uploads/news/'.$otop[0]->file_path);
            ...
            <div class="carousel-inner">
                ...
                <div class="item <?php echo ($i == 0)? "active":""; ?>">
                    <img src="<?php echo asset('uploads/news/'.$otop[0]->file_path).'/'.$file_name; ?>" alt="">
                </div>
                <?php } } ?>
            </div>
            <!-- Carousel controls -->
