...
<div class="page-banner no-subtitle">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2>สถานที่สำคัญ (ท่องเที่ยว)</h2>
      </div>
      <div class="col-md-6">
        <ul class="breadcrumbs">
          <li><a href="#">หน้าแรก</a></li>
          <li>สถานที่สำคัญ (ท่องเที่ยว)</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="row sidebar-page">
      ...
      <div class="col-md-3 sidebar right-sidebar custom-page-content">
        ...
        <div class="widget widget-popular-posts">
          <h4>สถานที่สำคัญ (ท่องเที่ยว) <span class="head-line"></span></h4>
          <ul>
            <?php
                if(isset($landmarks_all[0])){
                    foreach ($landmarks_all as $key => $value) {
            ?>
            <li>
  ...
  <div class="col-md-9 page-content custom-right-sidebar">
    ...
    <div class="blog-post image-post">
      ...
      <div class="post-content">
        ...
        <h2><a href="#">{{ $landmarks[0]->title }}</a></h2>
        <ul class="post-meta">
          <li>By <a href="#">Administrator</a></li>
          <li>เมื่อวันที่ {{ date("d-m-Y", strtotime($landmarks[0]->post_date)) }}</li>
          <!-- <li><a href="#">WordPress</a>, <a href="#">Graphic</a></li>
          <li><a href="#">4 Comments</a></li> -->
        </ul>
        <p><?php echo $landmarks[0]->detail1 ?></p>
...
<br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                <?php if(isset($landmarks[0]->file_path)){
                        $path = public_path('uploads/news/'.$landmarks[0]->file_path);
            ...
            <div class="carousel-inner">
                ...
                <div class="item <?php echo ($i == 0)? "active":""; ?>">
                    <img src="<?php echo asset('uploads/news/'.$landmarks[0]->file_path).'/'.$file_name; ?>" alt="">
                </div>
                <?php } } ?>
            </div>
            <!-- Carousel controls -->
