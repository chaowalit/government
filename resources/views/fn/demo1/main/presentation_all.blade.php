...
<div class="page-banner no-subtitle">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2>นำเสนอผลงาน อปท.ทั้งหมด</h2>
      </div>
      <div class="col-md-6">
        <ul class="breadcrumbs">
          <li><a href="#">หน้าแรก</a></li>
          <li>นำเสนอผลงาน อปท.ทั้งหมด</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-9 page-content custom-right-sidebar">
    ...
    <div class="blog-post image-post">
      ...
      <div class="post-content">
        ...
        <h2><a href="#"> นำเสนอผลงาน อปท.ทั้งหมด </a></h2>
        <ul class="post-meta">
        ...
        <table id="dataTableNews" class="display" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value->title }}</td>
                    <td style="text-align: center;">
                        <a class="main-button" href="<?php echo url('detail/presentation').'/'.$value->id; ?>">อ่านเพิ่มเติม
