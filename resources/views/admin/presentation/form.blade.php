...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#" class="active">นำเสนอผลงาน อปท.<?php //echo $menu_name; ?></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"><?php echo $type_form == 'create'? "บันทึกข้อมูลหน้าข่าวนำเสนอผลงาน อปท.":"แก้ไขข้อมูลหน้าข่าวนำเสนอผลงาน อปท."; ?>
                <small>สามารถสร้างรูปแบบเนื้อหาที่จะแสดงหน้าเว็บได้ตามต้องการ</small>
                <a href="{{ url('/admin/presentation') }}"><u style="font-size: 12px;">ย้อนกลับ</u></a>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                ...
                <form role="form" action="{{ url('admin/presentation/save') }}" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/presentation') }}" class="btn btn-warning">ยกเลิก</a>
                  </div>
                </form>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="<?php echo url('/admin/presentation/select').'/'.$result[0]->id.'/'.$file_name; ?>">เลือก</a>
                                    &nbsp;&nbsp;
                                    <a href="<?php echo url('/admin/presentation/delete').'/'.$result[0]->id.'/'.$result[0]->file_path.'/'.$file_name; ?>" onclick="return confirm('คุณต้องการลบรายการนี้หรือไม่ ?')">
                                        ลบรูปภาพ
                                    </a>
                                </td>
                            </tr>
