...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php //echo $menu_name; ?>
        วีดีโอวิดิทัศน์ (Youtube)
        <!-- <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> เมนูหลัก</a></li>
        <li><a href="#" class="active">วีดีโอวิดิทัศน์ (Youtube)<?php //echo $menu_name; ?></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"><?php echo $type_form == 'create'? "บันทึกข้อมูลหน้าวีดีโอวิดิทัศน์ (Youtube)":"แก้ไขข้อมูลหน้าวีดีโอวิดิทัศน์ (Youtube)"; ?>
                <small>สามารถสร้างรูปแบบเนื้อหาที่จะแสดงหน้าเว็บได้ตามต้องการ</small>
                <a href="{{ url('/admin/vdo_youtube') }}"><u style="font-size: 12px;">ย้อนกลับ</u></a>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                ...
                <form role="form" action="{{ url('admin/vdo_youtube/save') }}" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="file_path" id="file_path" placeholder="Link Youtube" value="<?php echo isset($result[0]->file_path)? $result[0]->file_path:""; ?>">
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/vdo_youtube') }}" class="btn btn-warning">ยกเลิก</a>
                  </div>
                </form>
