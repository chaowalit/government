...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#" class="active">เผยแพร่การคำนวณราคากลาง<?php //echo $menu_name; ?></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"><?php echo $type_form == 'create'? "บันทึกข้อมูลข่าวเผยแพร่การคำนวณราคากลาง":"แก้ไขข้อมูลข่าวเผยแพร่การคำนวณราคากลาง"; ?>
                <small>สามารถสร้างรูปแบบเนื้อหาที่จะแสดงหน้าเว็บได้ตามต้องการ</small>
                <a href="{{ url('/admin/cal_mid_price') }}"><u style="font-size: 12px;">ย้อนกลับ</u></a>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                ...
                <form role="form" action="{{ url('admin/cal_mid_price/save') }}" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/cal_mid_price') }}" class="btn btn-warning">ยกเลิก</a>
                  </div>
                </form>
            </div>
          </div>
