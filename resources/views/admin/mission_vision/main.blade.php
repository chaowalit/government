        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
                <form role="form" action="{{ url('about/mission_vision/save') }}" method="post" enctype="multipart/form-data">
                    <!-- /.box-body -->
                    <textarea id="detail1" name="detail1" rows="10" cols="80">
                        <?php echo @$mission_vision[0]->detail1; ?>
                    </textarea>

                  <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="hidden" name="edit_id" id="edit_id" value="<?php echo isset($mission_vision[0]->id)? $mission_vision[0]->id:""; ?>">
