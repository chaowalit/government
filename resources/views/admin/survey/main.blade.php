                      ...
                      <?php if($summary_survey['total'] != 0){ ?>
                        ...
                        <tr>
                          ...
                          <td>ข้อมูลข่าวสารที่ขอดู/ขอรับบริการ
                            <ul class="">
                              <li ><p class="break-word"><span class="badge bg-white">แผ่นพับแนะนำ<?php echo $contact_us[0]->location_name; ?>(โครงสร้างและการจัดการองค์กรในการดำเนินงาน สรุปอำนาจหน้าที่ที่สำคัญและวิธีการดำเนินงานและสถานที่ติดต่อเพื่อขอรับข้อมูลข่าวสารหรือคำแนะนำในการติดต่อกลับกับหน่วยงานรัฐ)
                              </span></p>
                              </li>
