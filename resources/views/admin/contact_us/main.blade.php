...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo \Config::get('config_memu.main_6'); ?>
        <!-- <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> เมนูหลัก</a></li>
        <li><a href="#" class="active"><?php echo \Config::get('config_memu.main_6'); ?></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">กรอกข้อมูลการ<?php echo \Config::get('config_memu.main_6'); ?>
