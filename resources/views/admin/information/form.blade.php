        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"><?php echo $type_form == 'create'? "บันทึกข้อมูลข่าวสารประชาสัมพันธ์":"แก้ไขข้อมูลข่าวสารประชาสัมพันธ์"; ?>
                <small>สามารถสร้างรูปแบบเนื้อหาที่จะแสดงหน้าเว็บได้ตามต้องการ</small>
                <a href="{{ url('/admin/information') }}"><u style="font-size: 12px;">ย้อนกลับ</u></a>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                ...
                <form role="form" action="{{ url('admin/information/save') }}" method="post" enctype="multipart/form-data">
                  <div class="box-body">
