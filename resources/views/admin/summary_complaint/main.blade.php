        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">แสดงผลการร้องเรียน/ร้องทุกข์
            ...
            <div class="box-body pad">
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                      ...
                      <?php if($ComplainRequest['total'] > 0){ ?>
                        <tr>
                          <td>1.</td>
                          <td>เพศ
                            <ul class="">
                          ...
                          <td>&nbsp;
                                <ul class="ul-non">
                                  <li><span class="badge bg-green"><?php echo $ComplainRequest['sex']['male']; ?></span></li>
                                  <li><span class="badge bg-green"><?php echo $ComplainRequest['sex']['female']; ?></span></li>
                                </ul>
                          </td>
                          <td>
                              &nbsp;
                                <ul class="ul-non">
                                  <li><span class="badge bg-green"><?php echo $ComplainRequest['sex']['male']/$ComplainRequest['total']*100; ?>%</span></li>
                                  <li><span class="badge bg-green"><?php echo $ComplainRequest['sex']['female']/$ComplainRequest['total']*100; ?>%</span></li>
                                </ul>
                          </td>
                        </tr>
                      ...
                      <tr>
                          ...
                          <td>
                              <span class="badge bg-green"><?php echo $ComplainRequest['total']; ?></span>
                          </td>
                        </tr>
                      </tbody></table>
                    </div>
