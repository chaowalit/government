...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#" class="active">ผลิตภัณฑ์ OTOP<?php //echo $menu_name; ?></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title"><?php echo $type_form == 'create'? "บันทึกข้อมูลหน้าผลิตภัณฑ์ OTOP":"แก้ไขข้อมูลหน้าผลิตภัณฑ์ OTOP"; ?>
                <small>สามารถสร้างรูปแบบเนื้อหาที่จะแสดงหน้าเว็บได้ตามต้องการ</small>
                <a href="{{ url('/admin/otop') }}"><u style="font-size: 12px;">ย้อนกลับ</u></a>
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                ...
                <form role="form" action="{{ url('admin/otop/save') }}" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="{{ url('/admin/otop') }}" class="btn btn-warning">ยกเลิก</a>
                  </div>
                </form>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="<?php echo url('/admin/otop/select').'/'.$result[0]->id.'/'.$file_name; ?>">เลือก</a>
                                    &nbsp;&nbsp;
                                    <a href="<?php echo url('/admin/otop/delete').'/'.$result[0]->id.'/'.$result[0]->file_path.'/'.$file_name; ?>" onclick="return confirm('คุณต้องการลบรายการนี้หรือไม่ ?')">
                                        ลบรูปภาพ
                                    </a>
                                </td>
                            </tr>
